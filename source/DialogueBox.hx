...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		if (PlayState.SONG.song.toLowerCase()=='empty')
		{
			portraitLeft = new FlxSprite(210, 240);
			portraitLeft.frames = Paths.getSparrowAtlas('kingPortrait','shared');
			portraitLeft.animation.addByPrefix('enter', 'kingTalk', 24, false);
			...
			portraitRight = new FlxSprite(684.05, 245);
			portraitRight.frames = Paths.getSparrowAtlas('bfPortrait','shared');
			portraitRight.animation.addByPrefix('enter', 'boyfriendTalk', 24, false);
		...
		if (PlayState.SONG.song.toLowerCase()=='stuck')
			{
				portraitLeft = new FlxSprite(210, 240);
				portraitLeft.frames = Paths.getSparrowAtlas('kingPortrait','shared');
				portraitLeft.animation.addByPrefix('enter', 'kingStressTalk', 24, false);
		...
		if (PlayState.SONG.song.toLowerCase()=='limbo')
			{
				portraitLeft = new FlxSprite(210, 240);
				portraitLeft.frames = Paths.getSparrowAtlas('kingPortrait','shared');
				portraitLeft.animation.addByPrefix('enter', 'kingManifestingTalk', 24, false);
				//portraitLeft.setGraphicSize(Std.int(portraitLeft.width * PlayState.daPixelZoom * 0.175));
				portraitLeft.updateHitbox();
				portraitLeft.scrollFactor.set();
				add(portraitLeft);
		...
		if (PlayState.SONG.song.toLowerCase()=='portal' || PlayState.SONG.song.toLowerCase()=='portal-potty')
			{
				portraitLeft = new FlxSprite(210, 240);
				portraitLeft.frames = Paths.getSparrowAtlas('kingPortrait','shared');
				portraitLeft.animation.addByPrefix('enter', 'kingPortalTalk', 24, false);
				//portraitLeft.setGraphicSize(Std.int(portraitLeft.width * PlayState.daPixelZoom * 0.175));
				portraitLeft.updateHitbox();
				portraitLeft.scrollFactor.set();
				add(portraitLeft);
		...
		dropText.font = 'Monsterrat';
		dropText.color = 0xFF7D7D7D;
		add(dropText);

		swagDialogue = new FlxTypeText(240, 550, Std.int(FlxG.width * 0.6), "", 32);
		swagDialogue.font = 'Monsterrat';
